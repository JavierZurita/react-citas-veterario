...
export default function Formulario( {pacientes, setPacientes, paciente} ){
    ...
    useEffect(() => {
        if(pacientes.length>0){setNombre(paciente.nombre);
        ...
        <div className="md:w-1/2 lg:w-2/5 mx-5">
            ...
            <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg py-10 px-5 mb-5">
                ...
                <div className="mb-5">
                    ...
                    <input id="email" type="email" placeholder="Introduzca el email" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md"
